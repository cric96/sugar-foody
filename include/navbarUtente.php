<nav class="navbar navbar-expand-lg navbar-light bg fixed-top">
  <div class="container">
    <a class="img-item navbar-left" href="sceltaRistorante.php">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
       <ul class="navbar-nav ml-auto">
          ...
          <!--Controllo da pagina carrello se non ho ordine-->
          <li class="nav-item">
             <a class="nav-link" href="riepilogoOrdine.php">Carrello</a>
          </li>
          <li class="nav-item">
